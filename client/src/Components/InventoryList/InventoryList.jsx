                ...
                <div className="inventory__heading">
                    ...
                    <div className="inventory__heading-functions">
                        <div className="inventory__search-bar">
                            ...
                            <input type="text" className="inventory__search-input" placeholder="Search..."/>
                        </div>
                        <Link to="/inventory/add"><button className="inventory__add-button">+ Add New Item</button></Link>
                    </div>
                </div>
                <ul className="inventory__list">
                    ...
                    <li className="inventory__list-item" key={item.id}>
                        <div className="inventory__item-content">
                            <div className="inventory__label-wrap inventory__item-name">
                                <h3 className="inventory__label">
                                    INVENTORY ITEM
                                    <img src={sortIcon} alt="sort icon" className="inventory__sort-icon"/>
                                </h3>
                                <Link to={`/inventory/${item.id}`} className="inventory__link">
                                    <p className="inventory__name">
                                        {item.itemName}
                                        <img src={chevronIcon} alt="chevron icon" className="inventory__name-icon"/>
                                    </p>
                                </Link>
                            </div>
                            ...
                            <div className="inventory__label-wrap inventory__item-status">
                                ...
                                (item.status === 'In Stock'?"inventory__status--instock":"inventory__status--outstock")}>{item.status.toUpperCase()}
                                </p>
                            </div>
                        ...
                        <div className="inventory__item-actions">
                            <h3 className="inventory__label inventory__label-actions">ACTIONS</h3>
                            <div className="inventory__actions-functions">
                                <img src={deleteIcon} alt="delete icon" className="inventory__delete"/>
                                <Link to={`/inventory/${item.id}/edit`}><img src={editIcon} alt="edit icon" className="inventory__edit"/></Link>
                            </div>
                        </div>
                    </li>
                    )}
