            ...
            <div className="warehouseList__card">
                <div className="warehouseList__card-text-container">
                    ...
                    <div className="warehouseList__card-sub-container">
                        ...
                        <p className="warehouseList__card-content warehouseList__card-content-mobile">{props.name}</p>
                        <p className="warehouseList__card-content warehouseList__card-content-tablet">{props.address}</p>
                    </div>

                    <div className="warehouseList__card-sub-container">
                        <h3 className="warehouseList__card-title">ADDRESS</h3>
                        <p className="warehouseList__card-content warehouseList__card-content-mobile">{props.address}</p>
                        <p className="warehouseList__card-content warehouseList__card-content-tablet">{props.name}</p>
                    </div>
                ...
                <a><img className="warehouseList__card-edit-button" src={DeleteIcon} alt="Delete Icon" /></a>
                    <a><img className="warehouseList__card-edit-button" src={EditIcon} alt="Edit Icon" /></a>
                </div>
            </div>
        </>
    )
