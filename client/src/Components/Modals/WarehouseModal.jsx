      ...
      <>
        ...
        <Modal show={this.state.show}>
          <div className="del_modal">
            ...
            <p className="modal__body">Please confirm that you'd like to delete this from the list of warehouses. You won't be able to undo this action.</p>
            <button className="modal__cancel button" onClick={() => this.closeModal()}>Cancel</button>
            {/* <button>Delete</button>  I need a clickhandler to delete */}
